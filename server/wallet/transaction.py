...
from server.config import MINING_REWARD
from server.config import MINING_REWARD_INPUT
...
class Transaction:
    ...
    def create_output(self, sender_wallet, recipient, amount):
        ...
        output = {}
        #assign the amount value to the recipient
        output[recipient] = amount
        #the output has to record how much currency the sender should have the overall balance after the transaction is complete
        #also known as the change of the transaction
